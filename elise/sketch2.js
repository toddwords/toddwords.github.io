...
var lastAmp, currAmp;
var baseSize
var clips = ['geico2-1.mp3','geico2-3.mp3', 'geico2-4.mp3']
var images = ['gecko1.png', 'gecko2.gif', 'gecko3.png']
var currentClip;
var playlist = [];
...
function setup(){
  ...
  for (var i = 0; i < playlist.length; i++) {
    ...
    playNext();
      ...
      Things.push(new Thing(images[1], width - width/4, height,0,1))
      Things.push(new Thing(images[0], width - width/8, height/2,0,-4))
